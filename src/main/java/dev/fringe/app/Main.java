...
public class Main implements InitializingBean {
	...
	public RestTemplate restTemplate() {
		...
		restTemplate.setRequestFactory(new InterceptingClientHttpRequestFactory( new BufferingClientHttpRequestFactory(new SimpleClientHttpRequestFactory()), Collections.singletonList(new ApiRestLoggingRequestInterceptor())));
		return restTemplate;
	}
